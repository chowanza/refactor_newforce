    ...
    general: [
      {
        ...
        description:
          'Residential & Commercial construction from planning to final finishes.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Professional painting services for both exterior and interior projects.',
      },
      {
      ...
      },
      {
        ...
        description:
          'Hardwood, laminate, vinyl, and tile flooring installation services.',
      },
      {
        image: images.concrete,
        title: 'Concrete Work',
        description:
          'Driveways, patios, foundations, and custom concrete installations.',
      },
      {
        image: images.electricalPlumbing,
        title: 'Electrical and Plumbing Installations',
        description:
          'Electrical wiring, lighting, and plumbing installation for new builds and repairs.',
      },
      {
        image: images.hvac,
        title: 'HVAC Installation and Maintenance',
        description:
          'Efficient heating, ventilation, and air conditioning systems for your property.',
      },
      {
        image: images.waterDamage,
        title: 'Water Damage Restoration and Mitigation',
        description:
          'Rapid response for water damage restoration, including mold remediation.',
      },
      {
        image: images.deckOutdoor,
        title: 'Custom Decks and Outdoor Living Spaces',
        description:
          'Custom-built decks and outdoor living spaces designed for beauty and durability.',
      },
      {
        image: images.projectManagement,
        title: 'Permitting and Project Management',
        description:
          'We handle all phases of construction, from permits to project management.',
      },
    ],
    roofing: [
      {
        ...
        description:
          'Cost-effective and popular roofing option for residential properties.',
      },
      {
        image: images.inspections,
        title: 'Roof and Building Inspections',
        description:
          'Comprehensive inspections for roofs and buildings to identify potential issues.',
      },
      {
        image: images.metalRoofing,
        title: 'Metal Roofing',
        description:
          'Durable and energy-efficient roofing solution for all types of properties.',
      },
      {
        image: images.tileRoofing,
        title: 'Tile Roofing (Clay & Concrete)',
        description:
          'Classic look with excellent durability for extreme weather conditions.',
      },
      {
        image: images.flatRoofing,
        title: 'Flat Roofing (TPO, EPDM, and PVC)',
        description:
          'Durable and energy-efficient flat roofing solutions for modern homes and commercial buildings.',
      },
      {
        image: images.modifiedBitumen,
        title: 'Modified Bitumen Roofing',
        description:
          'Superior waterproofing for low-slope and flat roofs in commercial buildings.',
      },
      {
        image: images.slateRoofing,
        title: 'Slate Roofing',
        description:
          'Timeless and highly durable roofing solution, perfect for long-lasting installations.',
      },
      {
        image: images.woodShakeRoofing,
        title: 'Wood Shake Roofing',
        description:
          'Natural and rustic look with excellent insulation and aesthetic appeal.',
      },
      {
        image: images.syntheticRoofing,
        title: 'Synthetic Roofing',
        description:
          'Durable and affordable alternative that mimics natural products like slate, wood, or tile.',
      },
      {
        image: images.standingSeam,
        title: 'Standing Seam Metal Roofing',
        description:
          'Sleek and modern roofing solution with superior protection against harsh weather.',
      },
      {
        image: images.builtUpRoofing,
        title: 'Built-Up Roofing (BUR)',
        description:
          'Durable and waterproof roofing solution ideal for low-slope commercial roofs.',
      },
      {
        image: images.greenRoof,
        title: 'Green Roof Installation',
        description:
          'Eco-friendly roofing solution that incorporates vegetation layers for environmental sustainability.',
      },
      {
        image: images.roofCoating,
        title: 'Roof Coating and Maintenance',
        description:
          'Roof coating services to extend the life of your roof, including UV protection and energy efficiency improvements.',
      },
    ],
  }
